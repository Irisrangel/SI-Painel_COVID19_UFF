...
#  2.0         19/10/2021          Iris Rangel         Ajuste para carregar na STAGE a ultima versão da planilha disponibilizada.
# ==============================================================
#
#
# ==============================================================
...
def run():
    ...
    # Leitura do arquivo da população - Obs: dia 2021-9-2 foi a ultima data em que a planilha covid.csv foi disponibilizada.
    # Depois esse perido, os dados passaram a ser disponibilidades atraves do TABNET.
    logging.info("Leitura do arquivo {}".format('src/input/covid/2021/9/2/covid_2021-9-2-caa69309-4676-4451-9f26-8a5163f37722.gz'))
    covid = pd.read_csv('src/input/covid/2021/9/2/covid_2021-9-2-caa69309-4676-4451-9f26-8a5163f37722.gz', compression='gzip', encoding = "ISO-8859-1", sep=';', header=0)
    ...
    logging.info("covid_columns= {}".format(covid_columns))
    print(covid.head())
